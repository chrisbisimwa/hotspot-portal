...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.user-profiles.show', $userProfile->id) }}">{{ $userProfile->name }}</a></li>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-check mt-1">
                            <input type="checkbox" class="form-check-input" id="is_active_edit" wire:model.live="is_active">
