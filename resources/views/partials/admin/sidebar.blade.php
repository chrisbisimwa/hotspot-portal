<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
        <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="HotspotPortal Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ request()->is('admin/logs*') || request()->is('admin/settings*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('admin.monitoring.center')}}" class="nav-link {{ request()->is('admin/monitoring*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Centre de surveillance</p>
                            </a>
                        </li>
                        <li class="nav-item">
